...
for depth in depths:
    ...
    channels.append(chan_val)  # 假设 select_depth 返回的是 [1, T]，取第一个channel
...
ax0.set_yticks([])
ax0.xaxis.set_major_locator(ticker.MultipleLocator(100000))
...
plt.tight_layout()
plt.savefig("figs/sponsor_meeting_report_2025/DSS/DSS_nosc.png")
plt.show()