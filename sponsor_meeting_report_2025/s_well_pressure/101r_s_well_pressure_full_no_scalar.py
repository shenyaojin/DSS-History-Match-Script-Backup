...
for i, gauge_data in enumerate(gauge_data_all):
    ax.scatter(gauge_data.taxis, gauge_data.data, s=1, label=f'Gauge {i+1}', alpha=0.6)
...
plt.tight_layout()
plt.savefig("figs/sponsor_meeting_report_2025/production/s_well_plot_no_scalar.png")
plt.show()