...
#%% Load DAS data
DASdata_stg7_path = datapath + f"h_well/DAS/LFDASdata_stg{stage1}_hwell.npz"
DASdata_stg7interval_path = datapath + f"h_well/DAS/LFDASdata_stg{stage1}_interval_hwell.npz"
DASdata_stg8_path= datapath + f"h_well/DAS/LFDASdata_stg{stage2}_hwell.npz"
...
plt.suptitle(f"LF-DAS data with gauge in H well/stage {stage1} and {stage2}")
plt.tight_layout()
