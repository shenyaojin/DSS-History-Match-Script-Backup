...
line1, = ax4.plot(gauge_for_ax4.calculate_time(), gauge_for_ax4.data, color='black',
                  label = r'Gauge $\frac{dP}{dt}$')
...
line2, = ax41.plot(real_time_taxis_DAS, extracted_LFDAS_chan_filtered, color='red', label='LFDAS data', alpha=0.5)
...
ax4.legend([line1, line2], [line1.get_label(), line2.get_label()], loc='upper right')

plt.suptitle(f"LF-DAS data coplot with history matching result. \nDiffusivity drop to 1e-6 times than before")
# plt.tight_layout()
plt.savefig("figs/02132025_IMAGE25figure/coplotV1.png")
plt.show()