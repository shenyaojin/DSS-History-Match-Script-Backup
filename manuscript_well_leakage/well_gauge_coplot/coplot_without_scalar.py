...
color = 'blue'
pc_stg8_prop.plot(ax=ax2, useTimeStamp=True, title=None, color=color)
color = 'green'
pc_stg8_slurry_rate.plot(ax=ax21, useTimeStamp=True, title=None, color=color)
pc_stg8_pressure.rename("Treating Pressure Stage 8")
color = 'red'
pc_stg8_pressure.plot(ax=ax22, useTimeStamp=True, title=None, color=color)
