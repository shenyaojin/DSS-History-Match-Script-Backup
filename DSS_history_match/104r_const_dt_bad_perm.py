...
# Test run for 104r- bad perm using larger permeability.
...
# 1. basic parameters
output_dir = "output/1004r_bad_perm"
os.makedirs(output_dir, exist_ok=True)
input_file_name = os.path.join(output_dir, "DSS_bad_perm.i")
builder = ModelBuilder(project_name="DSS_bad_perm")
...
viz_utils.plot_point_samplers(folder=output_dir, output_dir="figs/1004r2025")
viz_utils.plot_vector_samplers(folder=output_dir, output_dir="figs/1004r2025")
