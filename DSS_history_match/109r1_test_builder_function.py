...
project_name = "1118_misfit_func"
# builder = build_baseline_model(project_name=project_name)

# Output the model
output_dir = "output/1118_misfit_func"
...
# pg_frame.load_npz("data/fiberis_format/post_processing/history_matching_pressure_profile_full.npz")

start_time = datetime.datetime(2020, 4, 1, 0, 0, 0)
