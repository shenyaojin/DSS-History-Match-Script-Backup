...
output_dir = "output/1001r_time_sequence"
os.makedirs(output_dir, exist_ok=True)

input_file_name = os.path.join(output_dir, "DSS_time_sequence.i")

builder = ModelBuilder(project_name="DSS_time_sequence")
...
gauge_data_for_moose.adaptive_downsample(120)
...
viz_utils.plot_point_samplers(folder=output_dir, output_dir="figs/1001r2025")
viz_utils.plot_vector_samplers(folder=output_dir, output_dir="figs/1001r2025")
