#%% In this script, I will implement a parameter scanner for the DSS data history match using fiberis.
# This script is based on 106_DSS_3xSingleFrac_match.py and incorporates Bayesian optimization
# similar to 105r_broader_param_scanner.py.
# Shenyao Jin, shenyaojin@mines.edu, 10/19/2025
...
project_name = "106r_DSS_3xSingleFrac_scanner"
...
def model_builder_with_parameters_single_frac(**kwargs) -> List[Data1D_MOOSEps]:
    ...
    success, stdout, stderr = runner.run(
            ...
            output_directory = moose_output_dir,
            num_processors = 20,
    ...
    plot_point_samplers(folder = moose_output_dir,
                        output_dir = fig_parent_dir)

    plot_vector_samplers(folder = moose_output_dir,
                         output_dir = fig_parent_dir)
...
for frac_loc_center in frac_locs_all:
    ...
    def objective(**params):
        ...
        try:
            simulation_results = model_builder_with_parameters_single_frac(instance_id=instance_id, **params)
