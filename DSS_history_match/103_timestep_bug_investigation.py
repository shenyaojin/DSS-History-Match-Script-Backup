...
# Cofirmed working, no numerical instability, DON'T MODIFY IT! -- Shenyao
...
output_dir = "output/1001_prototype_match"
...
#%% Plot the down sampled pore pressure data and original data
fig, ax = plt.subplots(figsize=(6, 3))
gauge_data_for_moose.rename("Downsampled data")
gauge_data_for_moose.plot(ax=ax, use_timestamp=True, use_legend=True)
ax.set_xlabel("Time (s)")

ax.set_ylabel("Pore Pressure (Pa)")
injection_pressure_dataframe.data *= 6894.76
injection_pressure_dataframe.rename("Original data")
injection_pressure_dataframe.plot(ax=ax, use_timestamp=True, use_legend=True)
ax.set_title("Pore Pressure Data")
plt.tight_layout()
plt.legend()
plt.show()
...
viz_utils.plot_point_samplers(folder=output_dir, output_dir="figs/10012025")
viz_utils.plot_vector_samplers(folder=output_dir, output_dir="figs/10012025")
